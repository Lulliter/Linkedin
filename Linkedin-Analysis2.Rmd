...
### Percentages and Proportions - HIGHEST DEGREE against Country of origin
```{r  eval=FALSE}
# Single variable 
...
### Percentages and Proportions - HIGHEST DEGREE/Seniority/Sector/Position against Country of origin with *Dplyr*  
```{r}
...
kable(aggreOrig_shortUK, format = "html", caption = "Ranking of cities by Origin") %>%  kable_styling(bootstrap_options = c("striped", "hover", full_width = T , position = "center",font_size = NULL))
...
kable(aggreDest_shortUK, format = "html", caption = "Ranking of cities by popular destination") %>% kable_styling(bootstrap_options = c("striped", "hover", full_width = T , position = "center",font_size = NULL))
```
* **INSIGHTs**: 
...
kable(aggreOrig_shortAustr, format = "html", caption = "Ranking of cities by Origin") %>%  kable_styling(bootstrap_options = c("striped", "hover", full_width = T , position = "center",font_size = NULL))
...
kable(aggreDest_shortAustr, format = "html", caption = "Ranking of cities by popular destination") %>% kable_styling(bootstrap_options = c("striped", "hover", full_width = T , position = "center",font_size = NULL))
```
* **INSIGHTs**: 
...
top3cit <- both[as.character( both$DESTINATION_REGION == "Greater New York City Area" | both$DESTINATION_REGION == "San Francisco Bay Area"), ]
...
# mosaicplot(table(top3$DESTINATION_REGION, top3$HIGHEST_DEGREE_OBTAINED), ylab = "Political Party", xlab = "Tax Reform Bill Opinion", main = "Opinion vs Party",          color = c("purple", "forestgreen"))

# qplot
qplot(x = DESTINATION_REGION, data = top3, fill = HIGHEST_DEGREE_OBTAINED, geom = "bar") +
theme(axis.text.x = element_text(angle=75, vjust=0.3), axis.text.y = element_text(size=10,face="bold") )  +
  labs(title="Highest degree across top 3 city in 3 countries")

# chi square test statistic (assuming indipendence)
chisq <- chisq.test(x = table(top3$DESTINATION_REGION, top3$HIGHEST_DEGREE_OBTAINED), correct = FALSE)
chisq

x<- table(top3$DESTINATION_REGION, top3$HIGHEST_DEGREE_OBTAINED)
x

chisq2 <- chisq.test(x,  correct = FALSE, simulate.p.value = TRUE)
chisq2
...
ggplot(top3, aes(x=DESTINATION_REGION, y=NEW_MEM_ID, fill=HIGHEST_DEGREE_OBTAINED)) +  geom_bar(aes(colour =HIGHEST_DEGREE_OBTAINED),stat="identity", position = "fill") +
theme(axis.text.x = element_text(angle=75, vjust=0.3), axis.text.y = element_text(size=10,face="bold") )  +
  labs(title="Highest degree across top 3 city in 3 countries")
...
```{r}
#
# mosaicplot(table(top3$DESTINATION_REGION, top3$SENIORITY), ylab = "Political Party", xlab = "Tax Reform Bill Opinion", main = "Opinion vs Party",          color = c("purple", "forestgreen"))

# qplot
qplot(x = DESTINATION_REGION, data = top3, fill = SENIORITY, geom = "bar") +
theme(axis.text.x = element_text(angle=75, vjust=0.3), axis.text.y = element_text(size=10,face="bold") )  +
  labs(title="SENIORITY across top 3 city in 3 countries")

# Test statistic (assuming indipendence)
chisq <- chisq.test(x = table(top3$DESTINATION_REGION, top3$SENIORITY), correct = FALSE)
chisq

# ggplot
ggplot(top3, aes(x=DESTINATION_REGION, y=NEW_MEM_ID, fill=SENIORITY)) +  geom_bar(aes(colour =SENIORITY),stat="identity", position = "fill") +
theme(axis.text.x = element_text(angle=75, vjust=0.3), axis.text.y = element_text(size=10,face="bold") )  +
  labs(title="SENIORITY across top 3 city in 3 countries")
...
```{r}
#
# mosaicplot(table(top3$DESTINATION_REGION, top3$EMPLOYER_INDUSTRY_SECTOR), ylab = "Political Party", xlab = "Tax Reform Bill Opinion", main = "Opinion vs Party",          color = c("purple", "forestgreen"))

# qplot
qplot(x = DESTINATION_REGION, data = top3, fill = EMPLOYER_INDUSTRY_SECTOR, geom = "bar") +
theme(axis.text.x = element_text(angle=75, vjust=0.3), axis.text.y = element_text(size=10,face="bold") )  +
  labs(title="EMPLOYER_INDUSTRY_SECTOR across top 3 city in 3 countries")

# Test statistic (assuming indipendence)
chisq <- chisq.test(x = table(top3$DESTINATION_REGION, top3$EMPLOYER_INDUSTRY_SECTOR), correct = FALSE)
chisq

# ggplot
ggplot(top3, aes(x=DESTINATION_REGION, y=NEW_MEM_ID, fill=EMPLOYER_INDUSTRY_SECTOR)) +  geom_bar(aes(colour =EMPLOYER_INDUSTRY_SECTOR),stat="identity", position = "fill") +
theme(axis.text.x = element_text(angle=75, vjust=0.3), axis.text.y = element_text(size=10,face="bold") )  +
  labs(title="EMPLOYER_INDUSTRY_SECTOR across top 3 city in 3 countries")
```
...
```{r}
#
# mosaicplot(table(top3$DESTINATION_REGION, top3$POSITION_FUNCTION), ylab = "Political Party", xlab = "Tax Reform Bill Opinion", main = "Opinion vs Party",          color = c("purple", "forestgreen"))

# qplot
qplot(x = DESTINATION_REGION, data = top3, fill = POSITION_FUNCTION, geom = "bar") +
theme(axis.text.x = element_text(angle=75, vjust=0.3), axis.text.y = element_text(size=10,face="bold") )  +
  labs(title="POSITION_FUNCTION across top 3 city in 3 countries")

# Test statistic (assuming indipendence)
chisq <- chisq.test(x = table(top3$DESTINATION_REGION, top3$POSITION_FUNCTION), correct = FALSE)
chisq

# ggplot
ggplot(top3, aes(x=DESTINATION_REGION, y=NEW_MEM_ID, fill=POSITION_FUNCTION)) +  geom_bar(aes(colour =POSITION_FUNCTION),stat="identity", position = "fill") +
theme(axis.text.x = element_text(angle=75, vjust=0.3), axis.text.y = element_text(size=10,face="bold") )  +
  labs(title="POSITION_FUNCTION across top 3 city in 3 countries")
```